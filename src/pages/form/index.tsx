...
export  function Form() {
    ...
    async function doLogin(){
        ...
        if (ress){
            ...
            setTimeout(() =>{setMessage(null as never)},3000)
        }
    }
    return (
        <View style={styles.container}>
            ...
            <SmallInput placeholder='E-mail' onChangeText={(text)=>setUser(text as never)}/>
            <SmallInput placeholder='Senha' secureTextEntry={true} onChangeText={(text)=>setPassword(text as never)}/>
